...
public class Page32 extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twothree);
        ...
        /*inc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != ListView.INVALID_POSITION) {
                    ...
                    g.incValue(position+84);
                    val.setText(Integer.toString(g.getValue(position+84)));
                }
            }
        });
    ...
    private class PAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ((Button) convertView.findViewById(R.id.increment)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != ListView.INVALID_POSITION) {
                            ...
                            x.setText(Integer.toString(g.getValue(position+84)));
                        }
                    }
                });
            ...
            stocks = getResources().getStringArray(R.array.stock);
            price = getResources().getStringArray(R.array.prices);
            holder.product.setText(stocks[position + 84]);
            holder.price.setText(price[position + 84]);
            holder.val.setText(Integer.toString(g.getValue(position+84)));
