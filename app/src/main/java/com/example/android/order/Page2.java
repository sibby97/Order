...
public class Page2 extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.onetwo_list);
        ...
        /*inc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != ListView.INVALID_POSITION) {
                    ...
                    g.incValue(position+17);
                    val.setText(Integer.toString(g.getValue(position+17)));
                }
            }
        });
    ...
    private class PAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ((Button) convertView.findViewById(R.id.increment)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != ListView.INVALID_POSITION) {
                            ...
                            x.setText(Integer.toString(g.getValue(position+17)));
                        }
                    }
                });
            ...
            stocks = getResources().getStringArray(R.array.stock);
            price = getResources().getStringArray(R.array.prices);
            holder.product.setText(stocks[position + 17]);
            holder.price.setText(price[position + 17]);
            holder.val.setText(Integer.toString(g.getValue(position+17)));
