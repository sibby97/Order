...
public class Page22 extends ListActivity {
        ...
        /*inc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != ListView.INVALID_POSITION) {
                    ...
                    g.incValue(position+67);
                    val.setText(Integer.toString(g.getValue(position+67)));
                }
            }
        });
    ...
    private class PAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ((Button) convertView.findViewById(R.id.increment)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != ListView.INVALID_POSITION) {
                            ...
                            x.setText(Integer.toString(g.getValue(position+67)));
                        }
                    }
                });
            ...
            stocks = getResources().getStringArray(R.array.stock);
            price = getResources().getStringArray(R.array.prices);
            holder.product.setText(stocks[position+ 67]);
            holder.price.setText(price[position + 67]);
            holder.val.setText(Integer.toString(g.getValue(position+67)));
