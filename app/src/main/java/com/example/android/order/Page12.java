...
public class Page12 extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.twoone);
        ...
        /*inc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != ListView.INVALID_POSITION) {
                    ...
                    g.incValue(position+50);
                    val.setText(Integer.toString(g.getValue(position+50)));
                }
            }
        });
    ...
    private class PAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
                ...
                ((Button) convertView.findViewById(R.id.increment)).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position != ListView.INVALID_POSITION) {
                            ...
                            x.setText(Integer.toString(g.getValue(position+50)));
                        }
                    }
                });
            ...
            stocks = getResources().getStringArray(R.array.stock);
            price = getResources().getStringArray(R.array.prices);
            holder.product.setText(stocks[position + 50]);
            holder.price.setText(price[position + 50]);
            holder.val.setText(Integer.toString(g.getValue(position+50)));
